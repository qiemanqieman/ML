...
data_path_root = '/data/wumin/dataset/fashion_mnist/'
bs = 100
results_folder = Path("./samples/ddpm/fashion_mnist")
...
if __name__ == '__main__':
    ...
    # model = torch.load('models/ddpm_fashion_mnist.pth').to(device)
    ...
    torch.save(model, 'models/ddpm_fashion_mnist.pth')
